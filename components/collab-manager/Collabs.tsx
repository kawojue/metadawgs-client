                            ...
                            <FadeInUp className="flex flex-col gap-6 md:gap-12 justify-center items-center">
                                <ul className="grid gap-4 max-w-xl mx-auto">
                                    <li className="flex gap-3 pool rounded-2xl after:rounded-2xl p-4 sm:p-6">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <span className="font-semibold font-fredoka text-lg md:text-xl">
                                                Get Access to Metadawgs Team
                                                Benefit
                                            </span>
                                            <span className="text-[#ACACAC] md:text-lg text-base">
                                                Outstanding performance can earn
                                                you an exclusive invitation to
                                                join the Metadawgs core team
                                            </span>
                                        </div>
                                    </li>
                                    ...
                                    <li className="flex gap-3 pool rounded-2xl after:rounded-2xl p-4 sm:p-6">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <span className="font-semibold font-fredoka text-lg md:text-xl">
                                                Get Early Access to Metadawgs
                                                Info-fi affiliate program
                                            </span>
                                            <span className="text-[#ACACAC] md:text-lg text-base">
                                                Metadawgs is pioneering the
                                                first Info-fi application on
                                                Solana. Get early access to earn
                                                from the Metadawgs upcoming
                                                Info-fi affiliate program.
                                            </span>
                                        </div>
                                    </li>
                                    ...
                                    <li className="flex gap-3 pool rounded-2xl after:rounded-2xl p-4 sm:p-6">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span className="text-[#ACACAC] md:text-lg text-base">
                                                Participate actively and qualify
                                                for exclusive Solana-based
                                                rewards during the Token
                                                Generation Event (TGE) our way
                                                of recognizing early
                                    ...
                                    <li className="flex gap-3 pool rounded-2xl after:rounded-2xl p-4 sm:p-6">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span className="text-[#ACACAC] md:text-lg text-base">
                                                ...
                                                and earn exclusive token
                                                rewards. Your efforts won’t go
                                                unnoticed get rewarded directly
                                                in our native token for driving
                                                impact across the Metadawgs
                                                ecosystem.
                                            </span>
                                        </div>
                                    </li>
                        ...
                        {!success && (
                            <>
                                ...
                                >
                                    ...
                                    <div className="grid gap-2">
                                        <label htmlFor="link">
                                            Submit a link to your social or any
