...
function Footer() {
  return (
    <div className="bg-black text-white p-4 md:px-[5%] md:py-6 px-6">
      <div className="flex justify-between items-center flex-wrap gap-x-6 gap-y-2">
        <FadeIn>
      ...
      <FadeIn className="text-center mt-6">
        <p className="text-sm">
          &copy; {new Date().getFullYear()} MetaDawgs. All rights reserved.
        </p>
      </FadeIn>
    </div>
  );
