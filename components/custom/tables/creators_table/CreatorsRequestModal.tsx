...
function CreatorsRequestModal({
  ...
  return (
    ...
    >
      <DialogContent
        className="sm:max-w-[456px] bg-white text-black shadow-lg border border-gray-200 rounded-3xl z-[9999]"
      ...
      >
        ...
        <div className="grid gap-4 py-4 content">
          <div className="row flex flex-col gap-2">
            ...
            <div className="bg-gray-50 rounded-lg p-4 min-h-24 border">
