        ...
        <ul className="flex flex-col gap-2">
          <li>
            <Link
              ...
              className={cn(
                ...
                pathname !== "/wherethemagicrestricted" && "text-[#5F80A0]"
              )}
            >
              <svg
                width="16"
              ...
              >
                <path
                  ...
                  fill={pathname === "/wherethemagicrestricted" ? "black" : "#5F80A0"}
                />
              </svg>
              Dashboard
            </Link>
          ...
          <li>
            <Link
              ...
              className={cn(
                "flex items-center gap-3 p-4 px-6 rounded-full hover:opacity-80",
                pathname.startsWith("/wherethemagicrestricted/users") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/wherethemagicrestricted/users") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="14"
              ...
              >
                <path
                  ...
                  fill={
                    pathname.startsWith("/wherethemagicrestricted/users") ? "black" : "#5F80A0"
                  }
                />
              </svg>
              Users
          ...
          <li>
            <Link
              ...
              className={cn(
                "flex items-center gap-3 p-4 px-6 rounded-full hover:opacity-80",
                pathname.startsWith("/wherethemagicrestricted/creators-request") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/wherethemagicrestricted/creators-request") && "text-[#5F80A0]"
              )}
            >
          ...
          <li>
            <Link
              ...
              className={cn(
                "flex items-center gap-3 p-4 px-6 rounded-full hover:opacity-80",
                pathname.startsWith("/wherethemagicrestricted/quests") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/wherethemagicrestricted/quests") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="14"
              ...
              >
                <path
                  ...
                  fill={
                    pathname.startsWith("/wherethemagicrestricted/quests") ? "black" : "#5F80A0"
                  }
                />
              </svg>
              Manage Quests
          ...
          <li>
            <Link
              ...
              className={cn(
                "flex items-center gap-3 p-4 px-6 rounded-full hover:opacity-80",
                pathname.startsWith("/wherethemagicrestricted/entries") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/wherethemagicrestricted/entries") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="16"
              ...
              >
                <path
                  ...
                  fill={
                    pathname.startsWith("/wherethemagicrestricted/entries") ? "black" : "#5F80A0"
                  }
                />
              </svg>
              Entries
            ...
            <Link
              ...
              className={cn(
                ...
                pathname.startsWith("/wherethemagicrestricted/create-quest") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/wherethemagicrestricted/create-quest") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="16"
            ...
            <Link
              ...
              className={cn(
                ...
                pathname.startsWith("/wherethemagicrestricted/list-special-quest") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/wherethemagicrestricted/list-special-quest") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="16"
          ...
          <li>
            <Link
              href={"/wherethemagicrestricted/create-special-quest"}
              className={cn(
                "flex items-center gap-3 p-4 px-6 rounded-full hover:opacity-80",
                pathname.startsWith("/wherethemagicrestricted/create-special-quest") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/wherethemagicrestricted/create-special-quest") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="16"
