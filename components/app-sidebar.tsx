        ...
        <ul className="flex flex-col gap-2">
            ...
            >
              ...
              >
                <path
                  ...
                  fill={pathname === "/admin" ? "black" : "#5F80A0"}
                />
              </svg>
              Dashboard
            </Link>
            ...
            <Link
              ...
              className={cn(
                ...
                pathname.startsWith("/admin/users") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/admin/users") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="14"
              ...
              >
                <path
                  ...
                  fill={
                    pathname.startsWith("/admin/users") ? "black" : "#5F80A0"
                  }
                />
              </svg>
              Users
            ...
            <Link
              ...
              className={cn(
                ...
                pathname.startsWith("/admin/quests") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/admin/quests") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="14"
              ...
              >
                <path
                  ...
                  fill={
                    pathname.startsWith("/admin/quests") ? "black" : "#5F80A0"
                  }
                />
              </svg>
              Manage Quests
            ...
            <Link
              ...
              className={cn(
                ...
                pathname.startsWith("/admin/entries") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/admin/entries") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="16"
              ...
              >
                <path
                  ...
                  fill={
                    pathname.startsWith("/admin/entries") ? "black" : "#5F80A0"
                  }
                />
              </svg>
              Entries
          ...
          <li>
            <Link
              ...
              className={cn(
                "flex items-center gap-3 p-4 px-6 rounded-full hover:opacity-80",
                pathname.startsWith("/admin/create-quest") &&
                  "bg-[#FFBE00] text-black shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.4)] shadow-[#000000]/20",
                !pathname.startsWith("/admin/create-quest") && "text-[#5F80A0]"
              )}
            >
              <svg
                width="16"
