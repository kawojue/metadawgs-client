                    ...
                    <ul className="grid gap-4 max-w-2xl mx-auto">
                        <li className="flex gap-5 pool rounded-2xl after:rounded-2xl p-6 sm:p-8">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="text-[#ACACAC] md:text-xl text-lg">
                                    Be part of the metadawgs creators club, talk
                                    about metadawgs on X and earn
                                </span>
                            </div>
                        </li>
                        ...
                        <li className="flex gap-5 pool rounded-2xl after:rounded-2xl p-6 sm:p-8">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="text-[#ACACAC] md:text-xl text-lg">
                                    Stay active and engage on {"Metadawgs'"}{" "}
                                    official X Post and special quests to
                                    collect sweet bones and earn rewards.
                                </span>
                            </div>
                        </li>
