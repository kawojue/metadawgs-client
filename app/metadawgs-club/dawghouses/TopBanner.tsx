...
import AffiliatePromptModal from "@/components/custom/modals/AffiliatePromptModal";
...
function TopBanner({
    ...
    const [showAffiliatePrompt, setShowAffiliatePrompt] =
    ...
    return (
        <>
                    ...
                    data={
                        userStats?.type === "dawghouse"
                            ? {
                                  ...
                                  totalVideos: formatNumberWithCommas(
            ...
            />
            <AffiliatePromptModal
                open={showAffiliatePrompt}
                onClose={() => setShowAffiliatePrompt(false)}
